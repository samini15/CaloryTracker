...
class TrackerOverviewViewModel @Inject constructor(
    private val preferences: Preferences.OnboardingPreferences,
        ...
        getFoodsForDateJob = trackerUseCases.getFoodsForDate(state.date)
            .onEach {  foods ->
                ...
                state = state.copy(
                    ...
                    trackedFood = foods,
                    meals = state.meals.map {
                        val nutrientsForMeal = nutrientsResult.mealNutrients[it.mealType] ?: return@map it.copy(carbs = 0, protein = 0, fat = 0, calories = 0)
                        it.copy(
